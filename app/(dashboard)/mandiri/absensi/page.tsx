...
function AbsensiContent() {
  ...
  useEffect(() => {
    // Specifically fetch mandiri kegiatan
    fetch("/api/mandiri/kegiatan").then((r) => r.json()).then((d) => setKegiatan(Array.isArray(d) ? d : []));
    ...
    <div>
      ...
      <div className="page-content">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 20 }}>
          ...
          <div className="card">
            <div className="card-header">
              <span className="card-title">Daftar Hadir Mandiri</span>
