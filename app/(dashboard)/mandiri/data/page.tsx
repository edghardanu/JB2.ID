                    ...
                    <tr key={user.id}>
                      ...
                      <td>
                        <div style={{ fontSize: "12px" }}>
                          <span style={{ fontWeight: 600 }}>{user.mandiriDesaNama || "-"}</span><br/>
                          <span className="text-muted" style={{ fontSize: "11px" }}>{user.mandiriKelompokNama || "-"}</span>
                        </div>
                      </td>
                      <td>
